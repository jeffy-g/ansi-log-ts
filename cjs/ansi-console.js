...
exports.toConsoleArgsFromAnsi = toConsoleArgsFromAnsi;
exports.isBrowser =
...
function toConsoleArgsFromAnsi(format, ...comingArgs) {
  if (!exports.isBrowser) return [format, comingArgs];
...
exports.logAnsi = (() => {
  if (!exports.isBrowser) return console.log;
  return (...argsIn) => {
...
//# sourceMappingURL=ansi-console.js.map
